...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 23 13:53:27 2017
...
d = DataGen(path)
modelPath = u"../word2vecModels/bigramAnnonces/w2v"
phrasesPath = u"../word2vecModels/bigramAnnonces/phrases" 
...
if(not os.path.isfile(modelPath)):
    ...
    w2v = gensim.models.Word2Vec(list(bigram[d]),sg=1,size=100,workers=4)
    w2v.save(modelPath)
else : 
